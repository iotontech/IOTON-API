/**
  ******************************************************************************
  * @file    umart_lite_plus_teste/src/usbd_conf.c
  ...
  ******************************************************************************
  * @remark
  * Funções HAL_PCD_MspInit, HAL_PCD_MspDeInit e USBD_LL_Init modificadas por
  * Kleber Lima da Silva (kleber.ufu@hotmail.com) em 26-Abril-2015
  *
  */
